...
INSERT INTO home_apps (app_id, label, glyph, tile, screen, portfolio_slug, sort_order, requires_auth, assign_users) VALUES
  ...
  ('music', 'Music', '🎧', 'linear-gradient(135deg,#ec4899,#581c87)', 'home', NULL, 3, FALSE, FALSE),
  ('legal', 'Legal', '⚖️', 'linear-gradient(135deg,#94a3b8,#1e293b)', 'home', NULL, 4, FALSE, FALSE),
  ('settings', 'Settings', '⚙️', 'linear-gradient(135deg,#9ca3af,#374151)', 'home', NULL, 5, FALSE, FALSE),
  ('project-a', 'Project A', '🚀', 'linear-gradient(135deg,#22d3ee,#0e7490)', 'home', 'project-a', 6, FALSE, FALSE),
  ('project-b', 'Project B', '🧪', 'linear-gradient(135deg,#a78bfa,#4c1d95)', 'home', 'project-b', 7, FALSE, FALSE),
  ('project-c', 'Project C', '🌿', 'linear-gradient(135deg,#34d399,#065f46)', 'home', 'project-c', 8, FALSE, FALSE),
  ('calendar', 'Calendar', '📅', 'linear-gradient(135deg,#34d399,#0f766e)', 'home', NULL, 9, TRUE, FALSE),
  ...
  ('support', 'Support', '🛠️', 'linear-gradient(135deg,#38bdf8,#1e3a8a)', 'dock', NULL, 3, FALSE, FALSE),
